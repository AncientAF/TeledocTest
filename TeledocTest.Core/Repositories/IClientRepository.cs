...
public interface IClientRepository
{
    ...
    Task<Guid> Create(Client client, IList<Guid>? foundersIds, CancellationToken cancellationToken);
    Task<Client> Update(Client client, IList<Guid>? foundersIds, CancellationToken cancellationToken);
